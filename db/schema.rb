...
ActiveRecord::Schema.define(version: 20150722110149) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "admin"
    t.string   "image_url",              default: "https://s3-ap-southeast-2.amazonaws.com/tipjarwellington/images/tipjar-logo.png"
